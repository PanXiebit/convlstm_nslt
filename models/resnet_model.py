...
class ModelResNet(tf.keras.Model):
    ...
    def call(self, inputs, beam_size=1, training=None, mask=None):
        if training:
            ...
            return self.argmax_predict(src_inputs, src_len, self.beam_size, training)
    ...
    def argmax_predict(self, src_inputs, src_len, beam_size, training):
        ...
        # beam search
            ...
            beam_decoder_instance = tfa.seq2seq.BeamSearchDecoder(
                cell=self.Decoder.attention_rnn_cell,
